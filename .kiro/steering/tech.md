...
## AR & 3D Visualization
- **Variant Launch SDK** for cross-platform AR (iOS App Clips + Android WebXR)
...
- **WebXR API** (via Variant Launch compatibility layer)
- Full iOS and Android support with seamless QR code experience
