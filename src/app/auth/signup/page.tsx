      ...
      <div className="hidden lg:flex flex-1 bg-gray-50 items-center justify-center p-12">
        <div className="max-w-md text-center">
          ...
          <p className="text-gray-600 leading-relaxed">
            Join thousands of restaurants using AI to enhance their customer experience and streamline operations.
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600">Start your restaurant&apos;s AI transformation</p>
          </div>
          ...
          <form onSubmit={handleSignup} className="space-y-6">
            ...
            <div>
              <label htmlFor="restaurantName" className="block text-sm font-semibold text-black mb-2">
                Restaurant Name
              </label>
              <input
                id="restaurantName"
